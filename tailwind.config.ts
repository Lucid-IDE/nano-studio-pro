  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-camera-body": "var(--gradient-camera-body)",
        "gradient-camera-grip": "var(--gradient-camera-grip)",
        "gradient-button-3d": "var(--gradient-button-3d)",
        "gradient-dial-3d": "var(--gradient-dial-3d)",
      },
      boxShadow: {
        ...
        "3d-dial": "var(--shadow-3d-dial)",
        "3d-inset": "var(--shadow-3d-inset)",
        "camera-body": "var(--shadow-camera-body)",
      },
      transitionProperty: {
